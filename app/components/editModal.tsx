...
//     if (token) {
//       try {
//         // First, fetch the current note to get its aiSummary
//         const noteResponse = await axios.get(`http://3.108.64.68:8080/notes/${noteId}`, {
...
//           // Include the aiSummary in the update
//           onNoteUpdate({ 
//             _id: noteId, 
//             title, 
//             content, 
//             tags,
//             aiSummary: currentAiSummary // Preserve the original AI summary
//           });
//           closeModal();
//         });
//       } catch (error) {
